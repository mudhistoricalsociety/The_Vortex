...

{
	...
	send_to_char("*************************************************\n\r", ch);
	sprintf(buf, "The Vortex By Kale, SaTaN, and Sluggo\n\r             Version Number : 1\n\r");
	send_to_char(buf,ch);
	send_to_char("        Original God Wars Coding by KaVir\n\r", ch);
        send_to_char("              Diku was created by:\n\r", ch);
        send_to_char(" Katha Nyboe, Tom Madsen, Hans Henrik Staerfeldt,Michael Seifert, and Sebastian Hammer\n\r", ch); 
        send_to_char("              Merc was created by:\n\r", ch);
        send_to_char("            Furey, Hatchet, and Kahn\n\r", ch);
	send_to_char("*************************************************\n\r", ch);
