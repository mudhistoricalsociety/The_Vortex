...
$server     =   "infinity.wehostmuds.com";
$port       =   "7181";
...
$String        =   "What name shall you Live and Die by?";
...
$exec       =   "/disk0/icrontic/vortex/src/merc";

# Path where you want the mud logs to be kept.

$logdir     =   "/disk0/icrontic/vortex/log";

# Path where we should start the mud from.                              #
$startPath  =   "/disk0/icrontic/vortex/area";
...
if (&connect_server == 0) {
    ...
    print ("Connection to $server on port $port failed or timed out after 
$timeOut seconds!\n");
    ...
    &disconnect_server;
    print ("The connection was sucessful, but it doesn't seem to be 
responding\n");
    $time = (scalar localtime);
    print ("Attempting to restart the mud on $time...\n");
    system("killall $exec");
