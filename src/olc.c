...
/*mutter..won't compile..if someones working on this, just re-enable it..
    {	"chpoweron",	oedit_chpon	},
    {	"chpoweroff",	oedit_chpoff	},
    {	"chpoweruse",	oedit_chpuse	},
    {	"victpoweron",	oedit_vpon	},
    {	"victpoweroff",	oedit_vpoff	},
    {	"victpoweruse",	oedit_vpuse	},
    {	"spectype",	oedit_spectype	},
    {	"specpower",	oedit_specpower	},
    {	"quest",	oedit_quest	},
*/
    {   "?",		show_help	},
    {   "version",	show_version	},
...
if   ( !( !IS_NPC(ch) &&
                                ...
                                || strstr( pArea->builders, ch->name )
                                || strstr( pArea->builders, "All" ) ) ) )
...
void do_redit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !IS_BUILDER(ch, pRoom->area) && (ch->pcdata->security < 9))
	{
...
void do_oedit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !IS_BUILDER( ch, pObj->area ) && (ch->pcdata->security < 9))
	{
...
void do_medit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !IS_BUILDER( ch, pMob->area ) && (ch->pcdata->security < 9))
	{
...
void display_resets( CHAR_DATA *ch )
{
    ...
    send_to_char ( 
  " No.  Loads    Description       Location         Vnum   Mx  Description"
  "\n\r"
  "==== ======== ============= =================== ======== === ==========="
  "\n\r", ch );
	...
	case 'M':
	    ...
	    if ( !( pRoomIndex = get_room_index( pReset->arg3 ) ) )
	    {
            ...
            pMob = pMobIndex;
            sprintf( buf, "M[%5d] %-13.13s in room             R[%5d] %2d %-15.15s\n\r",
